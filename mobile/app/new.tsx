      ...
      <View className="mt-6 space-y-6">
        ...
        >
          {preview ? (
            <Image
              source={{ uri: preview }}
              className="rou h-full w-full object-cover"
            />
          ) : (
            <View className="flex-row items-center gap-2">
        ...
        <TextInput
          ...
          className="font p-0 text-lg text-gray-50"
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          className=" item-center mt-6 self-end rounded-full bg-green-500 px-5 py-2"
        >
          <Text className="text-center font-alt text-sm font-bold uppercase text-black ">
            Salvar
          </Text>
        </TouchableOpacity>
      </View>

  ...
  return (
    <form onSubmit={handleCreateMemory} className="flex flex-1 flex-col gap-2">
      <div className="flex items-center gap-4">
        <label
          className="flex cursor-pointer items-center gap-1.5 text-sm text-gray-200 hover:bg-gray-100"
          htmlFor="media"
        >
        ...
        <label
          htmlFor="isPublic"
          className="flex items-center gap-1.5 text-sm  text-gray-200 hover:bg-gray-100"
        >
          <input
            type="checkbox"
            name="isPublic"
